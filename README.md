...
2026 年 3 月 31 日，Anthropic 旗下的 AI 编程工具 Claude Code 的源码被泄露。这是目前最先进的 AI Agent 产品之一，其代码量达到 1905 个 TypeScript 源文件，涵盖了工具调用、多 Agent 协作、安全权限、上下文管理等 AI Agent 领域的核心技术。
...
Claude Code 采用五层解耦架构，1905 个源文件组织为清晰的职责分层：
